...
namespace _01_MainSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //veriler üzerinde işlem yapabilmemizi sağlayan, geçici olarak ramde tutulan programlama değerleridir
            // string
            ...
            //customerName = "Ayşegül"; artık customerName değişkeninin değeri değişti program ilk satırdan başlayarak okur ilk değeri yazdırır sonra aşağıdaki değeri yazdırır
